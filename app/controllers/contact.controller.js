...
//Retrieve all contact of a user from the databse
...
exports.findAllFavorite = async(_req, res, next) => {
    try{
        ...
        return next(new ApiError(500, "An error occurred while retriving favorite contacts")
        );
    }
};
...
exports.deleteAll = async(_req, res, next) => {
    try{
        ...
        return next(new ApiError(500, "An error occurred while removing al contacts")
        );
    }
};
